...
It contains the building blocks for coding sound 
on the cafe series loopers, 
ways to customize, 
an esoteric view on coding, 
as well as cool wifi connection procedures and sound files. 
This code nestles in the 90s couch 
of the cafe series instruments 
by "cat rumba". 
Such as cafeteria_mono, 
cafe_stereo, and so on. 
With an oversized mug of seattle brew, 
the instruments talk to their friends in the language of analog.

## Setup
- Buy the instrument. Thanks for your support. 
...
- Have a port wine (optional)
- From now on you will tinker with the code,
  save it to a new folder called peters_totally_weird_patch,
  and upload it in myriad ways and situations.
- Or you could minimally modify the preset list, etc.
